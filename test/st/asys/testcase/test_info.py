...
config = {
    ...
    'aic_voltage': {'get': ['ALL'], 'set': ['NULL'], 'restore': ['910B\\d', '910_93', '910_95']},
    'bus_voltage': {'get': ['ALL'], 'set': ['NULL'], 'restore': ['910B\\d', '910_93', '910_95']},
    ...
    'ddr_total': {'get': ['^(?!.*910B\\d)(?!.*910_93)(?!.*910_95).*'], 'set': ['NULL'], 'restore': ['NULL']},
    'ddr_used': {'get': ['^(?!.*910B\\d)(?!.*910_93)(?!.*910_95).*'], 'set': ['NULL'], 'restore': ['NULL']},
    'ddr_bandwidth': {'get': ['^(?!.*910B\\d)(?!.*910_93)(?!.*910_95).*'], 'set': ['NULL'], 'restore': ['NULL']},
    'ddr_frequency': {'get': ['^(?!.*910B\\d)(?!.*910_93)(?!.*910_95).*'], 'set': ['NULL'], 'restore': ['NULL']},
