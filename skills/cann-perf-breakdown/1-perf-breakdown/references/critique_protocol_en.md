# Independent Critique Protocol (English companion)

The canonical protocol is maintained in `critique_protocol.md`. This file is
kept as the paired English entry required by the repository documentation
checks.
