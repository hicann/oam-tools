...
private:
    ...
    int32_t ProfStartAscendProfHalTask(
        const uint64_t dataTypeConfig, const uint32_t devNums, CONST_UINT32_T_PTR devIdList) const;
    int32_t ProfStartHostServer(uint32_t moduleType, const uint32_t devNums, CONST_UINT32_T_PTR devIdList) const;
