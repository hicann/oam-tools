...
MdcV2Platform::MdcV2Platform()
{
    supportedFeature_ = {
        ...
        PLATFORM_TASK_MEMORY, PLATFORM_TASK_MSPROFTX, PLATFORM_TASK_SWITCH, PLATFORM_TASK_STARS_ACSQ,
        PLATFORM_TASK_TRACE, PLATFORM_TASK_TS_KEYPOINT, PLATFORM_TASK_TS_MEMCPY, PLATFORM_TASK_TRAINING_TRACE,
        PLATFORM_TASK_BLOCK, PLATFORM_TASK_INSTR_PROFILING,
        // PMU
