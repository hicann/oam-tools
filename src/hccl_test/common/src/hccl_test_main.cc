...
int main(int argc, char *argv[])
{
    ...
    if (ret == 1) {
        ...
        //入参解析失败
        printf_s("This is an error in parse_cmd_line.\n");
        goto hccltesterr2;
    }
    ...
    if (ret != 0) {
        printf_s("This is an error in get_mpi_proc.\n");
        goto hccltesterr2;
    }
    ...
    if (ret != 0) {
        printf_s("This is an error in check_cmd_line.\n");
        goto hccltesterr2;
    }
    ...
    if (ret != 0) {
        printf_s("This is an error in device_init.\n");
        goto hccltesterr2;
    }
    ...
    if (ret != 0) {
        printf_s("This is an error in get_env.\n");
        goto hccltesterr1;
    }
    ret = hccl_test->set_env_resource();
    if (ret != 0) {
        printf_s("This is an error in set_env.\n");
        goto hccltesterr1;
    }
...
hccltesterr1:
    ...
    if (ret != 0) {
        printf_s("This is an error in release_env_resource.\n");
    }
hccltesterr2:
    //删除构造器
