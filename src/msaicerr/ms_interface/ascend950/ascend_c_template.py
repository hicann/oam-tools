...
extern "C" __global__ __aicore__ void dirty_custom(GM_ADDR x, GM_ADDR z, GM_ADDR workspace, GM_ADDR tiling)
{
    uint32_t total_length = 256;
    uint32_t tile_num = 8;
    KernelDirty op;
    op.Init(x, z, total_length, tile_num);
    op.Process();
}
"""