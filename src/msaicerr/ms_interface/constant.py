...
class Constant:
    ...
    AIC_ERROR_INFO_DICT_DAVID = {
        0: {"name": "CUBE_ERR_L0A_RDWR_CFLT", "desc": "Software's L0A Ping/Pong memory allocation scheme has problem."},
        1: {"name": "CUBE_ERR_L0B_RDWR_CFLT", "desc": "Software's L0B Ping/Pong memory allocation scheme has problem."},
        2: {"name": "CUBE_ERR_L0C_RDWR_CFLT", "desc": "Software's L0C Ping/Pong memory allocation scheme has problem."},
        4: {"name": "CUBE_INVLD_INPUT", "desc": "the data read back from L0a and L0b are INF or NAN."},
        5: {"name": "CUBE_L0A_WRAP_AROUND", "desc": "The address for CUBE to operate L0A is out of bounds."},
        6: {"name": "CUBE_L0B_WRAP_AROUND", "desc": "The address for CUBE to operate L0B is out of bounds."},
        7: {"name": "CUBE_L0C_WRAP_AROUND", "desc": "The address for CUBE to operate L0C is out of bounds."},
        8: {"name": "CUBE_L0A_ECC",
        ...
        10: {"name": "CUBE_L0C_ECC",
             "desc": "A multi-bit ECC error occurs when CUBE reads L0C. See the RAS alarm handling."},
        11: {"name": "CUBE_ILLEGAL_INSTR",
             "desc": "The CUBE instruction is abnormal. Possible cause: The parameter violates the instruction "
                     "constraints, the binary version does not match, or the instruction is overwritten"},
        12: {"name": "CUBE_ERR_HSET_CNT_OVF", "desc": "An overflow error occurs in the CUBE HSET counter."},
        13: {"name": "CUBE_ERR_HSET_CNT_UNF", "desc": "An underflow error occurs in the CUBE HSET counter."},
        14: {"name": "CUBE_ERR_PBUF_WRAP_AROUND",
             "desc": "The address for CUBE to operate FIXP buffer is out of bounds."},
        15: {"name": "CUBE_ERR_PARITY_ERR", "desc": "Parity error for the Cube parity ERR register."},
        16: {"name": "CUBE_ERR_SF_ECC_MB_ERR",
             "desc": "A multi-bit ECC error occurs when CUBE reads MX buffer. See the RAS alarm handling."},
        17: {"name": "CUBE_ERR_L0ASF_WRAP_AROUND", "desc": "CUBE L0A memory read write conflict."},
        18: {"name": "CUBE_ERR_L0BSF_WRAP_AROUND", "desc": "CUBE L0B memory read write conflict."},
        32: {"name": "CUBE_INSTR_UNDEF", "desc": "The operation code is illegal."},
        33: {"name": "CUBE_INSTR_ILL_CFG", "desc": "The instruction configuration of CUBE is illegal."},
        34: {"name": "CUBE_INSTR_ADDR_MISALIGN", "desc": "The CUBE instruction address misalign."},
        35: {"name": "CUBE_FM_ADDR_OVERFLOW", "desc": "Feature map(conv/wino) of left matrix(matmul) exceeds L1."},
        36: {"name": "CUBE_NONBRANCH_BIAS_OVERFLOW", "desc": "Non-brc bias addr exceeds L1."},
        37: {"name": "CUBE_ELW_ADDR_OVERFLOW", "desc": "Elw addr exceeds L1."},
        38: {"name": "CUBE_KERNEL_ADDR_OVERFLOW", "desc": "Kernel(conv/wino) or right matrix(matmul) exceeds L1."},
        39: {"name": "CUBE_FB_ADDR_OVERFLOW", "desc": "Fixp parameter buffer addr exceeds 6k."},
        40: {"name": "CUBE_BT_ADDR_OVERFLOW", "desc": "Bias table addr exceeds L1."},
        41: {"name": "CUBE_RESULT_ADDR_OVERFLOW", "desc": "Cube result addr exceeds L1."},
        64: {"name": "MTE_NDDMA_CACHE_ECC",
             "desc": "A multi-bit ECC error occurs when MTE reads NDDMA cache. See the RAS alarm handling."},
        65: {"name": "MTE_NDDMA_REG_BUF_ECC",
        ...
        67: {"name": "MTE_CFG_REG_PARITY",
             "desc": "A parity error occurs when AICore reads the CFG register. See the RAS alarm handling"},
        68: {"name": "MTE_L0A_RDWR_CFLT", "desc": "CUBE L0A memory read write conflict."},
        69: {"name": "MTE_L0B_RDWR_CFLT", "desc": "CUBE L0B memory read write conflict."},
        71: {"name": "MTE_OFFSET_MISALIGN", "desc": "MTE gather/scatter dma instruction offset misalign."},
        72: {"name": "MTE_XGAMMA_LINE_SEQ_WRON",
             "desc": "In the xgamma operation, the first line is not loaded before computation begins;moreover, there "
                     ...
                     "next image."},
        73: {"name": "MTE_READ_OVERFLOW", "desc": "The address of the MTE 2D instruction to read L1 is out of bounds."},
        74: {"name": "MTE_WRITE_OVERFLOW",
             "desc": "The address of the MTE 2D instruction to write L1/L0A/L0B is out of bounds."},
        75: {"name": "MTE_BIF_CFG_REG_PARITY", "desc": "BIF configuration parity error."},
        78: {"name": "MTE_INSTR_ILLEGAL_CFG",
             "desc": "The MTE instruction is abnormal. Possible cause: The parameter violates the instruction "
                     "constraints, the binary version does not match, or the instruction is overwritten"},
        79: {"name": "MTE_ATM_ADD_ADDR_MISALIGN", "desc": "The MTE atomic instruction address is not aligned."},
        80: {"name": "MTE_INSTR_ADDR_MISALIGN", "desc": "The MTE non-atomic instruction address is not aligned."},
        81: {"name": "MTE_GDMA_READ_OVERFLOW",
             "desc": "The address for MTE2 to read UB and MTE3 to read L1/UB is out of bounds."},
        82: {"name": "MTE_GDMA_WRITE_OVERFLOW",
             "desc": "The address for MTE2 to write UB and MTE3 to write L1/UB is out of bounds."},
        83: {"name": "MTE_GDMA_ILLEGAL_BURST_NUM",
             "desc": "The burst number value of the MOV instruction is abnormal."},
        84: {"name": "MTE_GDMA_ILLEGAL_BURST_LEN",
             "desc": "The burst length value of the MOV instruction is abnormal."},
        85: {"name": "MTE_AIPP_ILLEGAL_PARAM", "desc": "AIPP decompression instruction configuration error."},
        86: {"name": "MTE_ERR_UNZIP", "desc": "UNZIP decompression instruction configuration error."},
        87: {"name": "MTE_XGAMMA_LB0_ECC", "desc": "MTE XGAMMA LB0 multi-bit ECC error."},
        88: {"name": "MTE_XGAMMA_LB1_ECC", "desc": "MTE XGAMMA LB1 multi-bit ECC error."},
        ...
        138: {"name": "L1_WINO_ILLEGAL_V_COV_PAD_CTL", "desc": "WINO V padding value is invalid."},
        139: {"name": "L1_WINO_ILLEGAL_H_COV_PAD_CTL", "desc": "WINO H padding value is invalid."},
        140: {"name": "L1_ILLEGAL_W_SIZE", "desc": "WINOA FMAP width + PADDING value is less than 4."},
        141: {"name": "L1_ILLEGAL_H_SIZE", "desc": "WINOA FMAP height + PADDING value is less than 4."},
        142: {"name": "L1_ILLEGAL_CHN_SIZE",
        ...
        143: {"name": "L1_ILLEGAL_K_M_EXT_STEP",
        ...
        144: {"name": "L1_ILLEGAL_K_M_START_POS",
        ...
        145: {"name": "L1_ILLEGAL_SCHN_CFG", "desc": "Small channel mode configuration error."},
        146: {"name": "L1_ILLEGAL_SMALLK_CFG", "desc": "LOAD3D small k configuration error."},
        147: {"name": "L1_ILLEGAL_FM_SIZE",
        ...
        148: {"name": "L1_ILLEGAL_L1_3D_SIZE", "desc": "LOAD3DV2 L1 3D size is invalid."},
        149: {"name": "L1_ILLEGAL_STRIDE", "desc": "The stride_w or stride_h of the LOAD3D instruction is 0."},
        150: {"name": "L1_PADDING_CFG", "desc": "The padding configuration of the LOAD3D instruction is invalid."},
        151: {"name": "L1_READ_3D_OVERFLOW",
             "desc": "The address for the LOAD3D instruction to read L1 is out of bounds."},
        152: {"name": "L1_WRITE_3D_OVERFLOW",
             "desc": "The address for the LOAD3D instruction to write L0A/L0B is out of bounds."},
        153: {"name": "L1_BAS_RADDR_OBOUND",
             "desc": "The initial address specified for the LOAD3D instruction is out of the L1 3D size range."},
        155: {"name": "L1_F1WPOS_LARGER_FSIZE",
        ...
        156: {"name": "L1_FMAP_LESS_KERNEL",
             "desc": "The width of the LOAD3D filter is greater than the width of the feature map plus padding. or "
                     ...
                     "padding."},
        157: {"name": "L1_FMAPWH_LARGER_L1SIZE",
             "desc": "The LOAD3D parameter is invalid. L1H*L1W*(C1+1) is greater than L1 buffer size/32."},
        158: {"name": "L1_FPOS_LARGER_FSIZE", "desc": "The LOAD3D K position is out of the filter range."},
        160: {"name": "L1_ERR_FIFO_PARITY", "desc": "L1/FIXP fifo parity."},
        161: {"name": "FIXP_BIU_RDWR_RESP", "desc": "The address for fixpipe to write GM is invalid"},
        162: {"name": "FIXP_STB_ECC_ERR",
             "desc": "A multi-bit ECC error occurs when fixpipe reads STB buffer. See the RAS alarm handling"},
        163: {"name": "FIXP_FBUF_WR_OVERFLOW", "desc": "The address for fixpipe to write FBUF is out of bounds."},
        164: {"name": "FIXP_FBUF_RD_OVERFLOW", "desc": "The address for fixpipe to read FBUF is out of bounds."},
        165: {"name": "FIXP_OUT_WR_OVERFLOW", "desc": "An overflow error occurs when the FIXP write."},
        166: {"name": "FIXP_L1_WR_OVERFLOW", "desc": "The address for fixpipe to write L1 is out of bounds."},
        167: {"name": "FIXP_L1_RD_OVERFLOW", "desc": "The address for fixpipe to read L1 is out of bounds."},
        168: {"name": "FIXP_L0C_RD_OVERFLOW", "desc": "The address for fixpipe to read L0C is out of bounds."},
        169: {"name": "FIXP_ILLEGAL_CFG", "desc": "The fixpipe instruction parameter is invalid."},
        170: {"name": "FIXP_ADDR_MISAL",
             "desc": "The address for fixpipe to read L0C, read/write L1, and read/write FBUF is not aligned."},
        171: {"name": "FIXP_L0C_ECC_ERR",
             "desc": "A multi-bit ECC error occurs when fixpipe reads L0C. See the RAS alarm handling."},
        172: {"name": "FIXP_L0C_RDWR_CFLT",
             "desc": "The address for fixpipe to read L0C conflicts with that for CUBE to write L0C."},
        173: {"name": "FIXP_WRITE_UB_OVFLW", "desc": "The address for fixpipe to write UB is out of bounds."},
        174: {"name": "L1_UB_WR_OVFLW", "desc": "The address for MTE to move from L1 to UB is out of bounds."},
        175: {"name": "L1_WAITSET_ERR", "desc": "The configuration of HWATI/HSET is invalid."},
        176: {"name": "L1_L1_ECC",
             "desc": "A multi-bit ECC error occurs when MTE/fixpipe reads L1. See the RAS alarm handling."},
        177: {"name": "L1_GDMA_READ_OVERFLOW",
             "desc": "The address for the MTE instruction to read L1 is out of bounds."},
        178: {"name": "L1_GDMA_WRITE_OVERFLOW",
             "desc": "The address for the MTE instruction to write the L0A/L0B bias table is out of bounds."},
        179: {"name": "L1_INSTR_ILLEGAL_CFG",
             "desc": "The MTE instruction is abnormal. Possible cause: The parameter violates the instruction "
                     "constraints, the binary version does not match, or the instruction is overwritten."},
        180: {"name": "L1_INSTR_ADDR_MISALIGN", "desc": "The MTE instruction address is not aligned."},
        181: {"name": "L1_SC_CFG_PARITY", "desc": "L1 SC configuration registers parity error."},
        182: {"name": "L1_FIXP_BT_NAN_INF", "desc": "MTE1 biasbuf path conversion NaN/Inf error."},
        192: {"name": "SC_CNT_SW_BUS_ERR",
             "desc": "During a slow context switch, SC encounters a bus error while transferring data."},
        193: {"name": "SC_REG_PARITY_ERR", "desc": "A parity error occurred in the CFG register inside SC."},
        194: {"name": "SC_SLOW_CSW_ROB_ECC_ERR",
             "desc": "During a slow CSW in SC, the ROB RAM from the SU's IFU is reused for reading,resulting in 2 "
                     "2-bit ECC error."},
        195: {"name": "SC_BUS_RESP_TIMEOUT_ERR", "desc": "The bus is busy, and the response times out."},
        256: {"name": "SU_IFU_BUS_ERR_T0",
             "desc": "The address of instruction is illegal when the AIcore reads instructions from GM.Possible "
                     "cause: The application unloads the operator binary in advance or stack corruption occurs."},
        257: {"name": "SU_CCU_CALL_DEPTH_OVRFLW_T0",
             "desc": "The number of nesting times of call the function is greater than CTRL[5:2]."},
        258: {"name": "SU_CCU_DIV0_T0", "desc": "divide by 0."},
        259: {"name": "SU_CCU_ILLEGAL_INSTR_T0",
        ...
        264: {"name": "SU_CCU_BUS_ERR_T0", "desc": "The address for scalar to access GM is invalid"},
        265: {"name": "SU_CCU_DC_DATA_ECC_T0",
             "desc": "A multi-bit ECC error occurs when scalar accesses dcache data. See the RAS alarm handling."},
        266: {"name": "SU_CCU_DC_TAG_ECC_T0",
        ...
        320: {"name": "VEC_ERR_UB_ARB_DATA_EXCP_MTE_T0", "desc": "Data from the MTE is abnormal."},
        321: {"name": "VEC_ERR_UB_ARB_DATA_EXCP_SU_T0", "desc": "Data from the CCU is abnormal."},
        322: {"name": "VEC_ERR_UB_ARB_DATA_EXCP_VEC_T0", "desc": "Data from the VEC is abnormal."},
        326: {"name": "VEC_ERR_INSTR_TIMEOUT_T0",
             "desc": "VEC VF execution timeout. Check the configuration of Runtime"},
        327: {"name": "VEC_ERR_SU_PLD_UNDEF_T0",
             "desc": "The non-VF instruction is abnormal. Possible cause: The parameter violates the instruction "
                     "constraints, the binary version does not match, or the instruction is overwritten."},
        328: {"name": "VEC_ERR_SU_PLD_ILL_CFG_T0", "desc": "The parameter of the non-VF instruction is invalid."},
        329: {"name": "VEC_ERR_PC_OVERFLOW_T0",
             "desc": "PC is greater than 48 bits. Possible cause: the compiler bug or the instruction is overwritten."},
        330: {"name": "VEC_ERR_INSTR_UNDEF_T0",
             "desc": "The instruction in VEC VF is abnormal. Possible cause: The parameter violates the instruction "
                     "constraints, the binary version does not match, or the instruction is overwritten."},
        331: {"name": "VEC_INSTR_ILLEGAL_CFG_T0", "desc": "The parameter of the VEC VF instruction is invalid."},
        332: {"name": "VEC_ERR_HWLP_STACK_OVFL_T0",
             "desc": "The number of nested VLOOP exceeds the hardware limit, which may be a compiler bug."},
        333: {"name": "VEC_ERR_HWLP_INSTR_NUM_MISMATCH_T0",
...
class RegexPattern:
    ...
    regex pattern
    """
    AICORE_ERR_OCCUR = r"(?P<err_time>\d+-\d+-\d+-\d+:\d+:\d+\.\d+\.\d+).+?\.(?:cc|cpp)\:\d+\](?P<thread_id>\d+)" \
    ...
    AICORE_ERR_OCCUR_OST = r"(?P<err_time>\d+-\d+-\d+-\d+:\d+:\d+\.\d+\.\d+).+?\.(?:cc|cpp)\:\d+\](?P<thread_id>\d+)" \
                    r".+?device\((?P<dev_id>[a-zA-Z0-9\s,:]{1,})\),\s" \
                    r"[a-zA-Z0-9\s,]{1,},\score id is (?P<core_id>\d+),\s+error code = " \
                    r"(?P<error_code>0x[0-9a-fA-F]+|\d+(?:,\s*\d+)*),.*?" \
