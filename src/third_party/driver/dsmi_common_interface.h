...
/* DSMI sub commond for DSMI_DETECT_MAIN_CMD_MEMORY */
...
typedef enum {
    DSMI_TRS_KERNEL_LAUNCH_HIGH_PERFORMANCE = 0,
    DSMI_TRS_KERNEL_LAUNCH_SECURITY,
    DSMI_TRS_MODE_MAX,
...
/* DSMI sub commond for UB module */
typedef enum {
...
* @return  0 for success, others for fail
* @note Support:Ascend610,bs9sx1a,Ascend310P,Ascend610Lite,Ascend910_95,Ascend910_55
*/
