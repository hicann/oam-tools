...
set(OPS_INFO_INSTALL_DIR            ${OAM_PREFIX}/built-in/op_impl/ai_core/tbe/config)
set(IMPL_INSTALL_DIR                ${OAM_PREFIX}/built-in/op_impl/ai_core/tbe/impl/ops_nn/ascendc)
set(IMPL_DYNAMIC_INSTALL_DIR        ${OAM_PREFIX}/built-in/op_impl/ai_core/tbe/impl/ops_nn/dynamic)
set(BIN_KERNEL_INSTALL_DIR          ${OAM_PREFIX}/built-in/op_impl/ai_core/tbe/kernel)
set(BIN_KERNEL_CONFIG_INSTALL_DIR   ${OAM_PREFIX}/built-in/op_impl/ai_core/tbe/kernel/config)
set(OPHOST_LIB_INSTALL_PATH         ${OAM_PREFIX}/built-in/op_impl/ai_core/tbe/op_host/lib/linux/${CMAKE_SYSTEM_PROCESSOR})
set(AICPU_KERNEL_IMPL               ${OAM_PREFIX}/built-in/op_impl/aicpu/kernel)
set(AICPU_JSON_CONFIG               ${OAM_PREFIX}/built-in/op_impl/aicpu/config)
set(OPTILING_LIB_INSTALL_DIR        ${OPHOST_LIB_INSTALL_PATH})
set(OPGRAPH_INC_INSTALL_DIR         ${OAM_PREFIX}/built-in/op_graph/inc)
set(OPGRAPH_LIB_INSTALL_DIR         ${OAM_PREFIX}/built-in/op_graph/lib/linux/${CMAKE_SYSTEM_PROCESSOR})
set(ONNX_PLUGIN_LIB_INSTALL_DIR     ${OAM_PREFIX}/built-in/framework/onnx)
