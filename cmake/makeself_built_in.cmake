...
# 执行安装到临时目录
execute_process(
    COMMAND "${CMAKE_COMMAND}" --install "${CPACK_CMAKE_BINARY_DIR}" --prefix "${STAGING_DIR}" --component oam-tools
...
execute_process(
    COMMAND python3 ${CANN_CMAKE_DIR}/scripts/package/package.py --pkg_name oam-tools --os_arch linux-${CPACK_ARCH}
