...
注：接口详细说明，请参见《[Runtime运行时API](https://hiascend.com/document/redirect/CannCommunityRuntimeApi)》。
<!-- end id22 -->
...
>接口详细说明，请参见《[Runtime运行时API](https://hiascend.com/document/redirect/CannCommunityRuntimeApi)》。
<!-- end id23 -->
...
详细的性能数据信息如请参考[性能数据参考](https://gitcode.com/Ascend/msprof/blob/26.1.0/docs/zh/user_guide/profile_data_file_references.md#db%E6%A0%BC%E5%BC%8F%E6%80%A7%E8%83%BD%E6%95%B0%E6%8D%AE)。
<!-- end id20 -->
