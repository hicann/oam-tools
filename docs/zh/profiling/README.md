...
- [msprof采集命令](./msprof_cmd/msprof_cmd.md)
  - [msprof采集通用命令](./msprof_cmd/general_collect_commands.md)
  - [采集AI任务运行性能数据](./msprof_cmd/ai_runtime_profile_data.md)
  - [采集AI处理器系统数据](./msprof_cmd/processorai_accelerator_system_data.md)
...
- [性能数据其他采集方式](./other_method/other_method.md)
...
- [附录](./appendices/appendices.md)
  ...
  - [安装perf、iotop、ltrace工具](./appendices/install_perf_iotop_ltrace.md)<!-- end id6 -->
